...
#ifndef GRAFEEX_RANDOM_NUMBER_H
#define GRAFEEX_RANDOM_NUMBER_H
...
namespace grafeex{
	namespace common{
		template <class value_type, class distribution_type = std::uniform_int_distribution<value_type>,
			class engine_type = std::mt19937, class seeder_type = std::random_device>
